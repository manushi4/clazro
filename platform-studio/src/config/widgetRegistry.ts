...
export const widgetRegistry: Record<string, WidgetMetadata> = {
  ...
  "profile.preferences": {
    ...
    name: "Preferences",
    description: "User preferences for notifications, appearance, language, and privacy",
    category: "profile",
    icon: "settings",
    allowedRoles: ["student", "teacher", "parent", "admin"],
    allowedScreenTypes: ["dashboard", "hub", "profile"],
    supportedSizes: ["compact", "standard"],
    defaultSize: "standard",
  },
  "profile.quickLinks": {
  ...
  "teacher.hero-card": {
    ...
    description: "Teacher greeting with avatar, quick stats (classes today, pending grading, attendance, at-risk students), and action buttons",
    category: "profile",
    icon: "user",
    allowedRoles: ["teacher"],
    allowedScreenTypes: ["dashboard"],
    supportedSizes: ["compact", "standard", "expanded"],
    defaultSize: "standard",
    requiredFeatureId: "teacher.dashboard",
  },
  "teacher.stats-grid": {
    id: "teacher.stats-grid",
    name: "Teacher Stats Grid",
    description: "4-stat grid showing total students, classes today, pending grading, and attendance with trends",
    category: "analytics",
    icon: "layout-grid",
    allowedRoles: ["teacher"],
    allowedScreenTypes: ["dashboard", "hub"],
  ...
  "teacher.upcoming-classes": {
    ...
    description: "Today's class schedule with time, subject, room, and current/next class indicators",
    category: "schedule",
    icon: "calendar-clock",
    allowedRoles: ["teacher"],
    allowedScreenTypes: ["dashboard", "hub"],
    supportedSizes: ["compact", "standard", "expanded"],
    defaultSize: "standard",
    requiredFeatureId: "teacher.schedule",
  },
  "teacher.pending-grading": {
    id: "teacher.pending-grading",
    name: "Pending Grading",
    description: "Assignments and tests pending review with progress and due dates",
    category: "schedule",
  ...
  "grading.recent": {
    id: "grading.recent",
    name: "Recent Grades",
    description: "Recently graded submissions with scores and grade letters",
    category: "schedule",
    icon: "check-circle",
    allowedRoles: ["teacher"],
    allowedScreenTypes: ["dashboard", "hub"],
  ...
  "grading.stats": {
    id: "grading.stats",
    name: "Grading Statistics",
    description: "Grading overview with assignments, pending/graded counts, average score, and grade distribution chart",
    category: "analytics",
    icon: "chart-bar",
    allowedRoles: ["teacher"],
    allowedScreenTypes: ["dashboard", "hub"],
  ...
  "teacher.grading-stats": {
    ...
    name: "Grading Statistics",
    description: "Grading overview with published assignments, pending/graded counts, average score, and grade distribution",
    category: "analytics",
    icon: "chart-bar",
    allowedRoles: ["teacher"],
    allowedScreenTypes: ["dashboard", "hub"],
  ...
  "grading.rubric-templates": {
    ...
    description: "Grading rubric templates for assignments with customizable criteria and scoring",
    category: "schedule",
    icon: "clipboard-list",
    allowedRoles: ["teacher"],
    allowedScreenTypes: ["dashboard", "hub"],
  ...
  "teacher.at-risk-students": {
    ...
    description: "Students needing attention with risk levels and performance metrics",
    category: "schedule",
    icon: "alert-triangle",
    allowedRoles: ["teacher"],
    allowedScreenTypes: ["dashboard", "hub"],
  ...
  "teacher.quick-actions": {
    ...
    name: "Teacher Quick Actions",
    description: "Quick access to common teaching tasks like attendance, grading, and assignments",
    category: "actions",
    icon: "zap",
    allowedRoles: ["teacher"],
    allowedScreenTypes: ["dashboard", "hub"],
  ...
  "teacher.create-assignment": {
    ...
    description: "Quick action widget to create new assignments with card, button, or banner variants",
    category: "actions",
    icon: "file-plus",
    allowedRoles: ["teacher"],
    allowedScreenTypes: ["dashboard", "hub"],
  ...
  "class.cards": {
    id: "class.cards",
    name: "Class Cards",
    description: "Grid of assigned classes with student count and schedule",
    category: "schedule",
    icon: "grid",
    allowedRoles: ["teacher"],
    allowedScreenTypes: ["dashboard", "hub"],
  ...
  "class.roster": {
    id: "class.roster",
    name: "Class Roster",
    description: "Student list with attendance and score stats",
    category: "schedule",
    icon: "users",
    allowedRoles: ["teacher"],
    allowedScreenTypes: ["dashboard", "hub", "detail"],
  ...
  "class.stats": {
    ...
    description: "Class performance metrics and analytics",
    category: "analytics",
    icon: "pie-chart",
    allowedRoles: ["teacher"],
    allowedScreenTypes: ["dashboard", "hub", "detail"],
  ...
  "class.activity": {
    id: "class.activity",
    name: "Class Activity",
    description: "Recent class activity timeline",
    category: "schedule",
    icon: "activity",
    allowedRoles: ["teacher"],
    allowedScreenTypes: ["dashboard", "hub", "detail"],
  ...
  "class.recentActivity": {
    ...
    description: "Filterable timeline of class activities with relative timestamps",
    category: "schedule",
    icon: "clock",
    allowedRoles: ["teacher"],
    allowedScreenTypes: ["dashboard", "hub"],
  ...
  "teacher.classOverview": {
    ...
    name: "Class Overview",
    description: "Expandable class-wise student overview with at-risk alerts and quick actions",
    category: "schedule",
    icon: "layers",
    allowedRoles: ["teacher"],
    allowedScreenTypes: ["dashboard", "hub"],
  ...
  "analytics.class-performance": {
    ...
    description: "Subject-wise performance with scores, grades, ranks, and trends",
    category: "analytics",
    icon: "bar-chart-2",
    allowedRoles: ["student", "teacher"],
    allowedScreenTypes: ["dashboard", "hub"],
  ...
  "teacher.attendanceHero": {
    ...
    description: "Today's attendance overview with rate, stats, and pending classes indicator",
    category: "analytics",
    icon: "check-square",
    allowedRoles: ["teacher"],
    allowedScreenTypes: ["dashboard", "hub"],
  ...
  "teacher.attendanceQuickActions": {
    ...
    name: "Attendance Quick Actions",
    description: "Quick action buttons for attendance tasks",
    category: "actions",
    icon: "zap",
    allowedRoles: ["teacher"],
    allowedScreenTypes: ["dashboard", "hub"],
  ...
  "teacher.attendanceRecent": {
    ...
    description: "Recently marked attendance records",
    category: "analytics",
    icon: "clock",
    allowedRoles: ["teacher"],
    allowedScreenTypes: ["dashboard", "hub"],
  ...
  "teacher.attendanceTrends": {
    ...
    description: "Attendance trends chart with 7/30/90 day views",
    category: "analytics",
    icon: "trending-up",
    allowedRoles: ["teacher"],
    allowedScreenTypes: ["dashboard", "hub"],
  ...
  "teacher.attendanceLowAlerts": {
    ...
    description: "Students with attendance below threshold with parent contact actions",
    category: "analytics",
    icon: "alert-triangle",
    allowedRoles: ["teacher"],
    allowedScreenTypes: ["dashboard", "hub"],
  ...
  "teacher.messages-inbox": {
    ...
    name: "Messages Inbox",
    description: "Parent and student messages with unread badge",
    ...
    supportedSizes: ["compact", "standard", "expanded"],
    defaultSize: "standard",
    requiredFeatureId: "teacher.communication",
  },
  "teacher.announcements": {
    id: "teacher.announcements",
    name: "Announcements",
    description: "Create and manage class announcements",
    category: "communication",
    icon: "megaphone",
    allowedRoles: ["teacher"],
    allowedScreenTypes: ["dashboard", "hub"],
  ...
  "teacher.parent-contacts": {
    ...
    description: "Searchable parent contacts with call and message actions",
    category: "communication",
    icon: "users",
    allowedRoles: ["teacher"],
    allowedScreenTypes: ["dashboard", "hub"],
  ...
  "teacher.doubts-inbox": {
    ...
    name: "Student Doubts",
    description: "Student questions with AI suggestions and priority filters",
    category: "communication",
    icon: "help-circle",
    allowedRoles: ["teacher"],
    allowedScreenTypes: ["dashboard", "hub"],
    supportedSizes: ["compact", "standard", "expanded"],
    defaultSize: "standard",
    requiredFeatureId: "teacher.doubts",
  },
  "teacher.doubt-detail": {
    id: "teacher.doubt-detail",
    name: "Doubt Detail",
    description: "Full doubt view with AI suggestion and answer form",
    category: "communication",
    icon: "message-circle",
    allowedRoles: ["teacher"],
    allowedScreenTypes: ["detail"],
  ...
  "teacher.calendar": {
    ...
    description: "Upcoming events grouped by date with quick add",
    category: "schedule",
    icon: "calendar",
    allowedRoles: ["teacher"],
    allowedScreenTypes: ["dashboard", "hub"],
    supportedSizes: ["compact", "standard", "expanded"],
    defaultSize: "standard",
    requiredFeatureId: "teacher.calendar",
  },
  "teacher.calendar-events": {
    id: "teacher.calendar-events",
    name: "Calendar Events",
    description: "Detailed event cards with type filters and create button",
    category: "schedule",
    icon: "calendar-days",
    allowedRoles: ["teacher"],
    allowedScreenTypes: ["dashboard", "hub", "profile"],
    supportedSizes: ["compact", "standard", "expanded"],
    defaultSize: "expanded",
    requiredFeatureId: "teacher.calendar-events",
  },
  "teacher.substitute-manager": {
    id: "teacher.substitute-manager",
    name: "Substitute Manager",
    description: "Combined widget for requesting substitutes and viewing available teachers",
    category: "schedule",
    ...
    supportedSizes: ["standard", "expanded"],
    defaultSize: "expanded",
    requiredFeatureId: "teacher.substitute-manager",
  },
  "teacher.leave-request": {
    id: "teacher.leave-request",
    name: "Leave Requests",
    description: "Manage leave applications with balance tracking and status filters",
    category: "schedule",
    icon: "calendar-off",
    allowedRoles: ["teacher"],
    allowedScreenTypes: ["dashboard", "hub"],
    supportedSizes: ["standard", "expanded"],
    defaultSize: "expanded",
    requiredFeatureId: "teacher.leave-request",
  },
  "teacher.ai-insights": {
    id: "teacher.ai-insights",
    name: "AI Insights",
    description: "Smart AI-powered recommendations and alerts for teaching effectiveness",
    category: "ai",
    icon: "brain",
    allowedRoles: ["teacher"],
    allowedScreenTypes: ["dashboard", "hub"],
    supportedSizes: ["standard", "expanded"],
    defaultSize: "expanded",
    requiredFeatureId: "teacher.ai-insights",
  },
  "teacher.recent-grades": {
    id: "teacher.recent-grades",
    name: "Recent Grades",
    description: "Recently graded assignments and submissions",
    category: "assessment",
    icon: "file-check",
    allowedRoles: ["teacher"],
    allowedScreenTypes: ["dashboard", "hub"],
  ...
  "teacher.rubric-templates": {
    ...
    name: "Rubric Templates",
    description: "Quick access to grading rubric templates",
    category: "assessment",
    icon: "clipboard-list",
    allowedRoles: ["teacher"],
    allowedScreenTypes: ["dashboard", "hub"],
  ...
  "teacher.grading-actions": {
    ...
    name: "Grading Actions",
    description: "Quick grading action buttons",
    category: "actions",
    icon: "edit-3",
    allowedRoles: ["teacher"],
    allowedScreenTypes: ["dashboard", "hub"],
  ...
  "teacher.student-stats": {
    ...
    name: "Student Stats",
    description: "Overview statistics for students",
    category: "analytics",
    icon: "bar-chart-2",
    allowedRoles: ["teacher"],
    allowedScreenTypes: ["dashboard", "hub"],
  ...
  "teacher.class-students": {
    ...
    name: "Class Students",
    description: "List of students in current class",
    category: "schedule",
    icon: "users",
    allowedRoles: ["teacher"],
    allowedScreenTypes: ["dashboard", "hub"],
  ...
  "teacher.top-performers": {
    ...
    name: "Top Performers",
    description: "Leaderboard of top performing students",
    category: "analytics",
    icon: "award",
    allowedRoles: ["teacher"],
    allowedScreenTypes: ["dashboard", "hub"],
  ...
  "teacher.student-quick-actions": {
    ...
    description: "Quick actions for student management",
    category: "actions",
    icon: "zap",
    allowedRoles: ["teacher"],
    allowedScreenTypes: ["dashboard", "hub"],
  ...
  "teacher.grading-hub-actions": {
    ...
    name: "Grading Hub Actions",
    description: "Main actions for the grading hub",
    category: "actions",
    icon: "layers",
    allowedRoles: ["teacher"],
    allowedScreenTypes: ["dashboard", "hub"],
  ...
  "teacher.submissions-list": {
    ...
    description: "List of student submissions awaiting review",
    category: "assessment",
    icon: "inbox",
    allowedRoles: ["teacher"],
    allowedScreenTypes: ["dashboard", "hub"],
  ...
  "teacher.grade-submission": {
    ...
    description: "Form to grade a specific submission",
    category: "assessment",
    icon: "check-square",
    allowedRoles: ["teacher"],
    allowedScreenTypes: ["dashboard", "hub"],
  ...
  "teacher.class-performance": {
    ...
    name: "Class Performance",
    description: "Performance analytics for your classes",
    category: "analytics",
    icon: "trending-up",
    allowedRoles: ["teacher"],
    allowedScreenTypes: ["dashboard", "hub"],
  ...
  "attendance.today-summary": {
    ...
    description: "Compact widget showing today's attendance with present/absent/late counts",
    category: "analytics",
    icon: "calendar-check",
    allowedRoles: ["teacher"],
    allowedScreenTypes: ["dashboard", "hub"],
  ...
  "attendance.quick-mark": {
    ...
    name: "Quick Mark Attendance",
    description: "One-tap attendance marking for pending classes with All Present button",
    category: "actions",
    icon: "check-circle",
    allowedRoles: ["teacher"],
    allowedScreenTypes: ["dashboard", "hub"],
  ...
  "attendance.trends": {
    ...
    name: "Attendance Trends",
    description: "Compact 7-day trend chart with week comparison",
    category: "analytics",
    icon: "trending-up",
    allowedRoles: ["teacher"],
    allowedScreenTypes: ["dashboard", "hub"],
  ...
  "attendance.alerts": {
    ...
    description: "Low attendance students with quick actions (call, WhatsApp)",
    category: "analytics",
    icon: "alert-triangle",
    allowedRoles: ["teacher"],
    allowedScreenTypes: ["dashboard", "hub"],
